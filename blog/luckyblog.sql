...
-- Records of about
-- ----------------------------
INSERT INTO `about` VALUES (1, 'title', '标题', '关于我');
-- INSERT INTO `about` VALUES (2, 'musicId', '网易云歌曲ID', '423015580');
INSERT INTO `about` VALUES (2, 'content', '正文Markdown', '');
INSERT INTO `about` VALUES (3, 'commentEnabled', '评论开关', 'true');
...
-- ----------------------------
-- Records of blog table
-- ----------------------------
INSERT INTO `blog` VALUES (
    NULL,
    'Vue3+Pinia 完整状态管理实战教程',
    '/img/article/vue-pinia.jpg',
    '<h2>一、Pinia 替代 Vuex 优势</h2><p>Pinia 是 Vue 官方新一代状态管理库，抛弃了 mutations，简化代码结构，完美适配组合式API。</p><h2>二、仓库创建规范</h2><p>统一放在 src/stores 目录，按业务拆分仓库，区分全局共享状态与组件局部状态。</p>',
    '本文讲解Vue3项目从Vuex迁移到Pinia完整步骤，包含仓库定义、组件取值、页面分页状态管理等实战代码示例。',
    b'1',
    b'1',
    b'0',
    b'1',
...
-- Records of tag
-- ----------------------------
INSERT INTO `tag` VALUES (1, 'Vue3', 'blue');
INSERT INTO `tag` VALUES (2, 'Pinia', 'green');
